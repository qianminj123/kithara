...
class MaxEngine(engine_api.Engine):
  ...
  def load_existing_params(self, params, rng=None) -> Params:
    ...
    self.prefill_kv_cache_annotations = max_utils.get_prefill_kv_cache_annotations(self.model, self.config, rng, self._mesh)
    ...
    self.kv_cache_annotations = max_utils.get_kv_cache_annotations(self.model, self.config, rng, self._mesh)
  ...
  def prefill_multisampling(*args, **kwargs):
      pass
