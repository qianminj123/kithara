...
def main():
    ...
    subprocess.run(["rm", "-rf", "/home/ubuntu/.cache/huggingface/hub"])
    ...
    from singlehost.continued_pretraining_example import run_workload

    # Save model outputs to GCS
    run_workload(
        gemma2_model_size="9b", model_output_dir="gs://wenxindong-vm/model_output"
    )
